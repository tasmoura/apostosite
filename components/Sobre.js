        ...
        <section id="sobre" className={sobreStyles.sobrecont}>
            ...
            <div className={sobreStyles.row}>
                <div className={sobreStyles.corpo}>
                    ...
                    <p>E ainda contamos com o nosso fiel escudeiro, o designer gráfico e programador Thiago, especialista em modelagem 3D há 8 anos. Calmo, bem humorado, é apaixonado por fantasia e história. Não dá pra deixar de dizer que ele é um viajante nato, atualmente reside em Portugal e é o braço direito da agência, remotamente.</p>
